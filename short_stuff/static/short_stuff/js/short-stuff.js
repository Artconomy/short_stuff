...
exports.genShortcode = exports.genShortcodeUuid = exports.unSlugify = exports.slugify = exports.padGuidBytes = void 0;
...
*/
function padGuidBytes(rawBytes) {
...
exports.padGuidBytes = padGuidBytes;
/**
* Takes a UUID and turns it into a URLencode compatible base64 slug.
*/
function slugify(uid) {
    const byteArray = [...(0, uuid_1.parse)(uid)];
...
function genShortcodeUuid(byteLength = 16) {
    ...
    return (0, uuid_1.v4)({ random: byteArray });
}
exports.genShortcodeUuid = genShortcodeUuid;
function genShortcode(byteLength = 8) {
    return slugify(genShortcodeUuid(byteLength));
}
exports.genShortcode = genShortcode;
